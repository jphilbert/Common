...
DROP VIEW misc.v_generate_tbl_ddl;
/**********************************************************************************************
...
**********************************************************************************************/
CREATE OR REPLACE VIEW misc.v_generate_tbl_ddl
AS
SELECT
 schemaname
 ,tablename
...
select listagg(ddl, '\n') within group (order by seq asc)
from misc.v_generate_tbl_ddl
where schemaname = 'member_layer' and tablename='member'
;
